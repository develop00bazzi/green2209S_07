        ...
        <div class="col-lg-12">
            <div class="show-results mt-5">
                <div class="float-left p-2">
                    <h5 class="text-dark mb-0 pt-2">${region}의 ${medicalSubject}</h5>
                </div>
                        ...
                        <ul class="list-inline mb-0">
                            <li class="list-inline-item mr-3">
                                <select id="medicalSubjectCode" name="medicalSubjectCode" class="nice-select">
                                    ...
                                    <option value="9" <c:if test="${medicalSubject=='마치통증의학과'}">selected</c:if>>마치통증의학과</option>
...
<%--                                        </li>--%>
                                        ...
                                        <br/>
                                        <li class="list-inline-item">
                                            <p class="f-15 mb-0"><i class="fa fa-phone mr-2" aria-hidden="true"></i><a href="tel:${hospitalInfoVO.telno}">${hospitalInfoVO.telno}</a></p>
                                        </li>
                                        <br/>
                                        <li class="list-inline-item">
                                            <div>
